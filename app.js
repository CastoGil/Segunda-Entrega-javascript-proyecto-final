...
//verificamos en la memoria si hay algo guardado y si lo hay lo mostramos..
if (localStorage.getItem('shopCell')) {
...
const vaciarCarrito = () => {
    if (localStorage.getItem('shopCell')) {
        localStorage.removeItem('shopCell')
    }
    shopCell = []
    mostrarTotal(compraTotal(shopCell))
    mostrarCuenta(shopCell)
...
const telefonos = [
    ...
    {nombre: 'Motorola G22 128GB', valor: 36499},{nombre: 'Motorola G22 128GB', valor: 36499},{nombre: 'Motorola G22 128GB', valor: 36499},{nombre: 'Motorola G22 128GB', valor: 36499},
